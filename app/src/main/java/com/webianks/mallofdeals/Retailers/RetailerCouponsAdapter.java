...
public class RetailerCouponsAdapter extends BaseAdapter {

	private Context con;
	ImageLoader imageLoader;
	DisplayImageOptions options;
	private Activity activity;
	List<RetailerCouponsSetterGetter> sgcl;
	Typeface tfRegular;
	Typeface tfSlab;

	public RetailerCouponsAdapter(Context context, Activity activity,
                                  List<RetailerCouponsSetterGetter> sgcl
    ) {
