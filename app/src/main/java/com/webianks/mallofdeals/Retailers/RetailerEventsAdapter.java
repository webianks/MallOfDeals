...
public class RetailerEventsAdapter extends BaseAdapter {

	private Context con;
	ImageLoader imageLoader;
	DisplayImageOptions options;
	private Activity activity;
	List<RetailerEventsSetterGetter> sgcl;
	Typeface tfRegular;
	Typeface tfSlab;

	public RetailerEventsAdapter(Context context, Activity activity,
                                 List<RetailerEventsSetterGetter> sgcl
    ) {
